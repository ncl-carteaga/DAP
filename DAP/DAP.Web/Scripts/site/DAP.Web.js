...
(function (DAP) {
    ...
    (function (DWSupport) {
        ...
        [,
            ...
            ['RmEstimatedAirCost', function () { return Serenity.DecimalEditor; }],
        ...
        ].forEach(function (x) { return Object.defineProperty(AirCostAdjSuppForm.prototype, x[0], {
            get: function () {
...
(function (DAP) {
    ...
    (function (DWSupport) {
        ...
        (function (AirCostAdjSuppRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = AirCostAdjSuppRow.Fields || (AirCostAdjSuppRow.Fields = {}));
            [
                'AirCostAdjId',
                'VoyageCd',
                'RmEstimatedAirCost',
...
(function (DAP) {
    ...
    (function (DWSupport) {
        ...
        (function (AirCostAdjSuppService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = AirCostAdjSuppService.Methods || (AirCostAdjSuppService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = AirCostAdjSuppService.baseUrl + '/' + x;
            });
...
(function (DAP) {
    ...
    (function (DWSupport) {
        var CruiseSegmentDaysOverrideForm = /** @class */ (function (_super) {
            ...
            function CruiseSegmentDaysOverrideForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
        ...
        [,
            ['CruiseCd', function () { return Serenity.StringEditor; }],
            ['CompanyCd', function () { return Serenity.StringEditor; }],
            ['CruiseDaysQty', function () { return Serenity.IntegerEditor; }],
            ['CruiseSegmentDaysQty', function () { return Serenity.IntegerEditor; }],
        ...
        ].forEach(function (x) { return Object.defineProperty(CruiseSegmentDaysOverrideForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (DAP) {
    ...
    (function (DWSupport) {
        ...
        (function (CruiseSegmentDaysOverrideRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = CruiseSegmentDaysOverrideRow.Fields || (CruiseSegmentDaysOverrideRow.Fields = {}));
            [
...
(function (DAP) {
    ...
    (function (DWSupport) {
        ...
        (function (CruiseSegmentDaysOverrideService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = CruiseSegmentDaysOverrideService.Methods || (CruiseSegmentDaysOverrideService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = CruiseSegmentDaysOverrideService.baseUrl + '/' + x;
            });
...
(function (DAP) {
    ...
    (function (DWSupport) {
        ...
        [,
            ...
            ['CompanyCd', function () { return Serenity.StringEditor; }],
            ['CappedCapacity', function () { return Serenity.IntegerEditor; }],
            ['OnbrdAvgPaxQty', function () { return Serenity.IntegerEditor; }],
            ['HighlightInd', function () { return Serenity.IntegerEditor; }],
            ['ColorInd', function () { return Serenity.StringEditor; }],
            ['DrydockInd', function () { return Serenity.IntegerEditor; }],
            ['VarToCurve', function () { return Serenity.DecimalEditor; }],
            ['ShowInDr001', function () { return Serenity.StringEditor; }],
            ['ShowInDr010', function () { return Serenity.StringEditor; }],
            ['ShowInCube', function () { return Serenity.StringEditor; }],
            ['IntlDatelineInd', function () { return Serenity.StringEditor; }],
            ['MinisegInd', function () { return Serenity.StringEditor; }],
            ['EffectiveFrom', function () { return Serenity.DateEditor; }],
            ['EffectiveTo', function () { return Serenity.DateEditor; }],
            ['LoadDt', function () { return Serenity.DateEditor; }]
        ].forEach(function (x) { return Object.defineProperty(DimCruiseFlagsForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (DAP) {
    ...
    (function (DWSupport) {
        ...
        (function (DimCruiseFlagsRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = DimCruiseFlagsRow.Fields || (DimCruiseFlagsRow.Fields = {}));
            [
                'DimCruiseFlagId',
                'CruiseCd',
                'CruiseSegmentCd',
...
(function (DAP) {
    ...
    (function (DWSupport) {
        ...
        (function (DimCruiseFlagsService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = DimCruiseFlagsService.Methods || (DimCruiseFlagsService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = DimCruiseFlagsService.baseUrl + '/' + x;
            });
