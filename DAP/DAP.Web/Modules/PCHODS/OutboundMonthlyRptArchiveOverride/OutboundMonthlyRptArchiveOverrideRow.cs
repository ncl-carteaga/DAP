...
namespace DAP.PCHODS.Entities
{
    ...
    [ConnectionKey("PCH_DW"), Module("PCHODS"), TableName("[dbo].[Outbound_monthly_rpt_archive_override]")]
    [DisplayName("Outbound Monthly Rpt Archive Override"), InstanceName("Outbound Monthly Rpt Archive Override")]
    ...
    public sealed class OutboundMonthlyRptArchiveOverrideRow : Row, IIdRow, INameRow
    {
        ...
        public OutboundMonthlyRptArchiveOverrideRow()
            : base(Fields)
        {
        }
