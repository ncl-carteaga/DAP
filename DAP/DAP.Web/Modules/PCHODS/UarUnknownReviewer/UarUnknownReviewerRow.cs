...
namespace DAP.PCHODS.Entities
{
    ...
    public sealed class UarUnknownReviewerRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Employee Id"), Column("EmployeeID"), Size(255), QuickSearch]
        ...
        [DisplayName("User Login Name"), Column("USER_LOGIN_NAME"), Size(50)]
        ...
        [DisplayName("User Full Name"), Column("USER_FULL_NAME"), Size(200)]
        ...
        [DisplayName("Firstname"), Column("FIRSTNAME"), Size(150)]
        ...
        [DisplayName("Middlename"), Column("MIDDLENAME"), Size(8000)]
        ...
        [DisplayName("Lastname"), Column("LASTNAME"), Size(150)]
        ...
        [DisplayName("Office Code"), Column("OFFICE_CODE"), Size(50)]
        ...
        [DisplayName("Comments"), Column("COMMENTS"), Size(5000)]
        ...
        [DisplayName("User Group Id"), Column("USER_GROUP_ID"), Size(50)]
        ...
        [DisplayName("User Group Name"), Column("USER_GROUP_NAME"), Size(200)]
        ...
        [DisplayName("Group Description"), Column("GROUP_DESCRIPTION"), Size(5000)]
        ...
        [DisplayName("User Group Rights"), Column("USER_GROUP_RIGHTS"), Size(200)]
        ...
        [DisplayName("Task Id"), Column("TASK_ID"), Size(50)]
        ...
        [DisplayName("Task Name"), Column("TASK_NAME"), Size(200)]
        ...
        [DisplayName("Critical Fuction"), Column("CRITICAL_FUCTION"), Size(1), NotNull]
        ...
        [DisplayName("Accesstype"), Column("ACCESSTYPE"), Size(5), NotNull]
        ...
        [DisplayName("Sup Employeeid"), Column("SUP_EMPLOYEEID"), Size(20)]
        ...
        [DisplayName("Reviewer Firstname"), Column("REVIEWER_FIRSTNAME"), Size(150)]
        ...
        [DisplayName("Reviewer Lastname"), Column("REVIEWER_LASTNAME"), Size(150)]
        ...
        [DisplayName("How Found"), Column("HOW_FOUND"), Size(100)]
        ...
        [DisplayName("Ad Manager"), Column("AD_Manager"), Size(50)]
        ...
        [DisplayName("Ad Active Status"), Column("AD_Active_Status"), Size(20)]
        ...
        [DisplayName("Hr Emp Status"), Column("HR_Emp_Status"), Size(20)]
        ...
        [DisplayName("Ad Description"), Column("AD_Description"), Size(200)]
