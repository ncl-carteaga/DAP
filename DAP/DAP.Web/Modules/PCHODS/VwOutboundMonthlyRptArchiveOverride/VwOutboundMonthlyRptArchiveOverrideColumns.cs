...
namespace DAP.PCHODS.Columns
{
    ...
    [ColumnsScript("PCHODS.VwOutboundMonthlyRptArchiveOverride")]
    [BasedOnRow(typeof(Entities.VwOutboundMonthlyRptArchiveOverrideRow), CheckNames = true)]
    public class VwOutboundMonthlyRptArchiveOverrideColumns
    {
