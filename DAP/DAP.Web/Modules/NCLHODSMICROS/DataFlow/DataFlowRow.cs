...
namespace DAP.NCLHODSMICROS.Entities
{
    using Serenity;
    ...
    [ConnectionKey("NCLH_ODS_MICROS"), Module("NCLHODSMICROS"), TableName("[etl].[Data_Flow]")]
    [DisplayName("CBS FR Data Flow"), InstanceName("Data Flow")]
    ...
    public sealed class DataFlowRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Description"), Column("description"), Size(500)]
        ...
        [DisplayName("Package"), Column("package"), Size(100)]
