...
namespace DAP.SSISConfig.Entities
{
    ...
    [ConnectionKey("Config"), Module("SSISConfig"), TableName("[dbo].[SSIS_Config_base]")]
    [DisplayName("SSIS Config Base (DWH)"), InstanceName("Ssis Config Base")]
    ...
    [DataAuditLog]
    public sealed class SsisConfigBaseRow : Row, IIdRow, INameRow
    {
        [DisplayName("Configuration Filter"), Size(100), NotNull, QuickSearch, QuickFilter(CssClass = "hidden-xs"), LookupEditor(typeof(Lookups.ConfigurationFilterLookup)), Updatable(false)]
        ...
        [DisplayName("Environment Enum"), NotNull, Visible(false),DefaultValue(0)]
        ...
        [DisplayName("Environment Desc"), Size(11), Visible(false), Updatable(false), SetFieldFlags(FieldFlags.Calculated)]
        ...
        [DisplayName("Modified By"), Size(60)]
        ...
        [DisplayName("Modified On"), DisplayFormat("yyyy/dd/MM HH:mm")]
