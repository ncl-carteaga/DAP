...
namespace DAP.NCLHDSAR.Entities
{
    ...
    [ConnectionKey("NCLH_DSAR"), Module("NCLHDSAR"), TableName("[etl].[Data_Flow]")]
    [DisplayName("DSAR Data Flow"), InstanceName("Data Flow")]
