...
namespace DAP.NCLHDSAR {
    ...
    export class SwAttributeGrid extends SwRequestAttributesGrid {
        protected getDialogType() { return SwAttributeDialog; }
        ...
        protected getColumns() {
            ...
            columns.splice(7, 0, {
                ...
                name: '',
                format: ctx => {
                    var CurItem = <SwRequestAttributesRow>ctx.item;
                    var klass = "";
