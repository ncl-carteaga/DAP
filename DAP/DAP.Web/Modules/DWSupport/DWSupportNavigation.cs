...
[assembly: NavigationLink(int.MaxValue, "DW Support/Marketing Toll-Free Inventory", typeof(MyPages.MarketingTollfreeBrandInventoryController), icon: null)]
...
[assembly: NavigationLink(int.MaxValue, "Brand Finance & Strategy/Region", typeof(MyPages.RegionController), icon: null)]
...
//[assembly: NavigationLink(int.MaxValue, "DW Support/Sailing Product Codes", typeof(MyPages.SlProductCodeSuppController), icon: null)][assembly: NavigationLink(int.MaxValue, "DW Support/PS GL Account Supp", typeof(MyPages.PsGlAccountSuppController), icon: null)]
//[assembly: NavigationLink(int.MaxValue, "DW Support/Amenity Details Supp", typeof(MyPages.AmenityDetailsSuppController), icon: null)]
