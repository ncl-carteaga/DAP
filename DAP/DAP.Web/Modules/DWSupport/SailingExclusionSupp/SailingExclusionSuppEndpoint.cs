namespace DAP.DWSupport.Endpoints
{
    ...
    using MyRepository = Repositories.SailingExclusionSuppRepository;
    using MyRow = Entities.SailingExclusionSuppRow;
    using DAP.DWSupport.Entities;

    [RoutePrefix("Services/DWSupport/SailingExclusionSupp"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class SailingExclusionSuppController : ServiceEndpoint
    {
        ...
        public FileContentResult ListExcel(IDbConnection connection, ListRequest request)
        {
            ...
            return ExcelContentResult.Create(bytes, "SailingExclusions" +
