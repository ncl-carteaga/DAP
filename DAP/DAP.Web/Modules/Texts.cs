    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your DAP Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your DAP Account";
                    ...
                    public static LocalText FormTitle = "Sign up for DAP";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "DAP";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText FooterCopyright = "Copyright (c) 2023 v1.90.01";
