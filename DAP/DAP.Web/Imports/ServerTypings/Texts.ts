    ...
    declare namespace Db {
        ...
        namespace PCHODSNVS {
            ...
            namespace SuppKeyAcctTarget {
                ...
                export const CompanyCd: string;
                export const FyCcfTargetFy1: string;
                export const FyCcfTargetFy2: string;
                export const FyCcfTargetFy3: string;
                export const FyCcfTargetFy4: string;
                export const FyCcfTargetFy5: string;
